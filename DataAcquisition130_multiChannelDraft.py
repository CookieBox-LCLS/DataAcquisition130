...
#set the number of channels to acquire on.  Note that the implementation will have to be specific based on the method used (simulated, or through LeCroy scope).
numberChannels = 2
